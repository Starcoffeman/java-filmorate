...
public class GenreController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Genre> getGenreById(@PathVariable("id") Integer id) throws IdIsNegativeException, GenreNotFoundException {
    ...
    public ResponseEntity<Genre> updateGenre(@RequestBody @Valid Genre updateGenre) throws InternalError,
            IdIsNegativeException, GenreNotFoundException {
